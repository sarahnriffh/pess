...
-- Database: `pess_sarah`
--
CREATE DATABASE IF NOT EXISTS `pess_sarah` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pess_sarah`;
...
('root', '[{\"db\":\"pess_sarah\",\"table\":\"patrolcar\"},{\"db\":\"pess_sarah\",\"table\":\"patrolcar_status\"},{\"db\":\"pess_sarah\",\"table\":\"incident_status\"},{\"db\":\"pess_sarah\",\"table\":\"incidenttype\"},{\"db\":\"pess_sarah\",\"table\":\"incident\"},{\"db\":\"pess_sarah\",\"table\":\"dispatch\"}]');
...
('root', '2019-03-04 05:54:44', '{\"Console\\/Mode\":\"collapse\"}');
